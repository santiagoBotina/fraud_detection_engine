...
Consumes fraud signal request messages, deserializes them, and delegates
to ProcessFraudSignalsUseCase for processing.
...
class FraudScoreRequestConsumer:
    ...
    def _handle_message(self, msg: Message) -> None:
        ...
        try:
            ...
            logger.info(
                "Successfully processed fraud signal request for transaction %s",
